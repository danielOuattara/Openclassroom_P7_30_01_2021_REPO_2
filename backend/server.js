...
const normalizePort = val => {
    ...
    // normalizePort() :  renvoie un port valide, qu'il soit fourni sous la forme d'un numéro 
    //                    ou d'une chaîne ;
...
server.on ('listening', () => {
    // écouteur d'évènements,  également enregistré, consignant le port ou le canal 
